...
class CNN:
    ...
    CNN classifier
    '''
    def __init__(self, train_x, train_y, test_x, test_y, epochs = 40, batch_size = 8):
    ...
    def make_model(self):
        ...
        self.model.add(Conv2D(50, kernel_size=(3, 3), padding='same',
                              activation='relu'))
        self.model.add(BatchNormalization())
        self.model.add(Conv2D(80, kernel_size=(3, 3),padding='same',
                              activation='relu'))
        self.model.add(BatchNormalization())
        ...
        self.model.add(BatchNormalization())
        self.model.add(MaxPool2D(pool_size=(2, 2)))
        self.model.add(Conv2D(100, kernel_size=(3, 3), padding='same',
                              activation='relu'))
        self.model.add(BatchNormalization())
        self.model.add(MaxPool2D(pool_size=(2, 2)))
        self.model.add(Conv2DTranspose(120, 3, strides=2, padding='valid',activation='relu'))
        self.model.add(BatchNormalization())
        self.model.add(Conv2D(1, kernel_size=(3, 4), padding='valid',
                              activation='relu'))
        self.model.add(BatchNormalization())
